...
1. Install BepInEx IL2CPP by downloading it from:
...
2. Edit FallGuys_client.ini so it contains the following values:
   TargetApplicationPath=FallGuys_client_game.exe
   WorkingDirectory=
   WaitForExit=0
   SkipEOS=0

3. Extract the Free Cam mod ZIP and copy the included folder into FallGuys\BepInEx\plugins.
